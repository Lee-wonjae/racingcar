...
public class Input {
    ...
    private final racingcar.view.InputValidator inputValidator;
    private final racingcar.view.InputParser inputParser;
    private final Scanner scanner;

    public Input(final racingcar.view.InputValidator inputValidator, final racingcar.view.InputParser inputParser, final Scanner scanner) {
